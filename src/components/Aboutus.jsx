      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center relative z-10">
        ...
        <div className="relative z-10">
          ...
          <h2 className="text-4xl md:text-5xl font-light leading-tight tracking-tight italic mb-6 text-gray-800">
            We <span className="font-semibold text-green-900">engineer</span>{" "}
            sports dreams — from{" "}
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            ...
            , we turn your vision into top-tier sports experiences — with
            quality, speed, and purpose built into every project.
          </p>
          ...
          <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="bg-white border border-green-100 rounded-xl p-6 shadow-sm hover:shadow-md transition">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Redefining sports infrastructure with sustainable,
